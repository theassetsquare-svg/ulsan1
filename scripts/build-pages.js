...
const SITE = 'https://e.nolcool.com';
...
function build(page) {
  ...
  if (page.slug) {
    out = out
      .replace('"@id": "https://e.nolcool.com/#article"', `"@id": "${page.url}#article"`)
      ...
      .replace('"mainEntityOfPage": "https://e.nolcool.com/"', `"mainEntityOfPage": "${page.url}"`)
      .replace('"@id": "https://e.nolcool.com/#breadcrumb"', `"@id": "${page.url}#breadcrumb"`)
